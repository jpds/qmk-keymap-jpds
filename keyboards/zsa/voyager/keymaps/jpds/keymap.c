...
enum layers { BASE, SYM, NAV, STENO, MOUSE };
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE]  = LAYOUT(
        ...
        OSM(MOD_LSFT),  MT(MOD_LGUI, KC_N), MT(MOD_LALT, KC_R), MT(MOD_LSFT, KC_T), MT(MOD_LCTL, KC_S), KC_G,          KC_P,           MT(MOD_RCTL, KC_H), MT(MOD_RSFT, KC_A), MT(MOD_RALT, KC_E), MT(MOD_RGUI, KC_I), RSFT_T(KC_SLSH),
        KC_LGUI,        ALT_T(KC_X),        KC_Q,               KC_M,               KC_W,               KC_Z,          KC_K,           KC_F,               KC_QUOT,            KC_SCLN,            KC_DOT,             KC_HYPR,
    ...
    [SYM]   = LAYOUT(
        ...
        _______,   KC_LABK, KC_LBRC, KC_LCBR, KC_LPRN, _______, KC_PLUS, KC_4,  KC_5,  KC_6,  KC_ASTR, _______,
        TO(STENO), KC_RABK, KC_RBRC, KC_RCBR, KC_RPRN, _______, _______, KC_1,  KC_2,  KC_3,  _______, KC_ENT,
                                              _______, _______, _______, KC_0
    ),
    [NAV]   = LAYOUT(
        RM_TOGG, QK_KB,   RM_NEXT, RGB_M_P, RM_VALD, RM_VALU, KC_BRID, KC_BRIU,      _______,   _______, _______, QK_BOOT,
        RM_HUEU, _______, KC_VOLD, KC_VOLU, KC_MUTE, _______, KC_PGUP, KC_HOME,      KC_DEL,    KC_END,  _______, KC_SLEP,
        LUMINO,  KC_MPRV, KC_MNXT, KC_MSTP, KC_MPLY, _______, KC_PGDN, KC_LEFT,      KC_DOWN,   KC_UP,   KC_RGHT, _______,
    ...
    [MOUSE] = LAYOUT(
        ...
        _______,  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______,  MS_BTN1, MS_WHLU, MS_WHLD, MS_BTN2, _______, _______, MS_LEFT, MS_DOWN, MS_UP,   MS_RGHT, _______,
